  ...
  return (
    ...
    >
      ...
      <motion.img
        ...
        animate={
          isInView ? { scale: 1, opacity: 0.7 } : { scale: 1.2, opacity: 0 }
        }
        transition={{
          type: "spring",
          stiffness: 100,
        ...
        <div className="flex justify-center items-center">
          <div className="relative flex justify-center mt-[5vh] h-[30vh] md:h-[50vh] xl:h-[60vh] w-[80vw] sm:w-[70vw] xl:w-[50vw]">
            ...
            >
              ...
              <a
                href="https://forms.gle/ixHsGp1LaUGmfMep7"
                target="_blank"
            ...
            <motion.div
              ...
              animate={
                isInView
                  ? { y: 0, rotate: -20, scale: 1, opacity: 1 }
            ...
            >
              <img src={doodle.image_16.src} alt={doodle.image_16.alt} />
            </motion.div>
            <motion.div
              ...
              animate={
                isInView
                  ? { y: 0, rotate: -30, scale: 1, opacity: 1 }
                  : { y: 100, rotate: -15, scale: 0.8, opacity: 0 }
              }
              transition={{
                type: "spring",
            ...
            >
              <img src={doodle.image_15.src} alt={doodle.image_15.alt} />
            </motion.div>
            <motion.div
            ...
            >
              <img src={doodle.image_14.src} alt={doodle.image_14.alt} />
            </motion.div>
            <motion.div
              ...
              animate={
                isInView
                  ? { y: 0, rotate: -10, scale: 1, opacity: 1 }
                  : { y: -100, rotate: 15, scale: 0.8, opacity: 0 }
              }
              transition={{ type: "spring", bounce: 0.4, duration: 1.5 }}
            >
              <img src={doodle.image_13.src} alt={doodle.image_13.alt} />
            </motion.div>
          </div>
        </div>
      </div>
