...
const BeautifiedFAQs = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-white to-blue-50" id="faq">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex mb-3 items-center space-x-2">
            ...
            >
              {[colors.blue, colors.red, colors.yellow, colors.green].map(
                (color, i) => (
                  <motion.span
                    key={i}
          ...
          >
            Find answers to the most common questions about the GDG Pune WOW
            event
          </motion.p>
        </motion.div>
                ...
                >
                  <motion.div
                    ...
                    animate={{
                      boxShadow:
                        activeId === faq.id
                          ? `0 10px 15px -3px ${faq.color}20, 0 4px 6px -2px ${faq.color}10`
                          : "none",
                      borderLeft:
                        activeId === faq.id
                          ? `4px solid ${faq.color}`
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        style={{
                          backgroundColor:
                            activeId === faq.id ? faq.color : "transparent",
                        }}
                        animate={{
